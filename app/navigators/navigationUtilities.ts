 ...
 */
export const navigationRef = createNavigationContainerRef<AppStackParamListLegacy>()
...
export function getActiveRouteName(state: NavigationState | PartialState<NavigationState>): string {
  ...
  if (!route.state) return route.name as keyof AppStackParamListLegacy

  // Recursive call to deal with nested routers
  return getActiveRouteName(route.state as NavigationState<AppStackParamListLegacy>)
}
...
export function useNavigationPersistence(storage: Storage, persistenceKey: string) {
  ...
  const routeNameRef = useRef<keyof AppStackParamListLegacy | undefined>(undefined)
  ...
  const onNavigationStateChange = (state: NavigationState | undefined) => {
    ...
    if (state !== undefined) {
      ...
      routeNameRef.current = currentRouteName as keyof AppStackParamListLegacy
